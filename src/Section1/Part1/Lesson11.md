# <span lang="ja">て</span> 形作为助动词及给予动词

除了将两个语句连接成一个句子外，<span lang="ja">て</span> 形还可以充当助动词。当 \<动词1\><span lang="ja">て</span>\<动词2\> 以这种方式使用时，第二个动词修饰第一个动词的核心含义。通常第二个动词有一个抽象的、常常是纯语法性的含义。
...
除了 <span lang="ja">てあげる</span> 和 <span lang="ja">てもらう</span>，还有第三个动词 <span lang="ja">てくれる</span>，它完成了给予/接收的"循环"：
...
稍后我们将看到 <span lang="ja">て</span> 助动词的其他用法，用来为像 <span lang="ja">ていく</span> 和 <span lang="ja">てくる</span> 这样的短语添加方向感。

对于 <span lang="ja">ない</span> 形的动词和形容词，还有另一种 <span lang="ja">て</span> 形版本，通常带有"助动词"的细微含义。在这种形式中，它不是 <span lang="ja">なくて</span>，而是变成 <span lang="ja">ないで</span>。
