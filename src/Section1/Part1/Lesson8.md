# <span lang="ja">い</span>-形容词

日语有两大类形容词。别担心，它们不像动词那么复杂。实际上相当简单。

这两类是 <span lang="ja">い</span>-形容词（<span lang="ja">形容詞</span>）和 <span lang="ja">な</span>-形容词（<span lang="ja">形容動詞</span>）。

<span lang="ja">い</span>-形容词的行为类似于动词，可以进行活用。而 <span lang="ja">な</span>-形容词的行为类似于名词（它们也常常可以作为名词使用）。我们稍后会讨论 <span lang="ja">な</span>-形容词。

以下是一个 <span lang="ja">い</span>-形容词的实际例子。
...
要用 <span lang="ja">い</span>-形容词表示某名词是/具有某种性质，你可以像这样直接用形容词构造一个"A 是 B"类型的句子：
...
<pre>
*<span lang="ja">火が赤いだ</span>
</pre>

这是**非常**错误的，不值得提供一个翻译。

然而，这里附上 <span lang="ja">です</span> 是可以的，但它在这种用法中不具有系词的作用。它只是添加了礼貌，没有任何实际含义。这是 <span lang="ja">だ</span> 和 <span lang="ja">です</span> 的第一个主要区别。当它不附着在名词上时，<span lang="ja">です</span> 只是一个礼貌标记。
...
由于动词中的 <span lang="ja">ない</span> 也表现为一个 <span lang="ja">い</span>-形容词，你可以像活用形容词一样活用它，继续构成活用链，从而构建我们之前提到的长动词串。
