...
让我们来看看更复杂的"A 做 B"类型的语句。我们将在后面的课程中介绍动词和活用，所以这里使用的例句仅作为一般性指引，不要试图拆解它们。

要理解"A 做 B"的句子，我们首先需要介绍"助词"和灵活语序的概念。

日语使用"助词"（<span lang="ja">助詞</span>），类似于介词，来定义词语与句子其他部分之间的关系。日语助词位于其所修饰的短语或词之后，而不是之前。我们说助词"附着"在它们左侧的词上。我们在上一课中已经看到了类似助词的东西：<span lang="ja">だ</span> 系词。

在英语中，我们使用语序来理解每个词在句子中的角色：主语、动词、宾语。

这些角色被称为"格"，每个角色是一个特定的"格"。日语使用助词来表示这些角色，这就是为什么它们通常被称为"格助词"。当我们想说助词所附着的词在句子中承担了所述的角色时，我们说该助词"标记"了该角色。

日语有一个默认的语序，有时如果含义可以从上下文中推断出来，助词甚至可以省略，但一般来说，使用助词是常态。有些词也可以在句子中"自由"存在而不带助词，我们将在后面的课程中讨论它们。

记住：这些翻译仅用于演示。这里的句子和翻译仅用于说明，不是用于教学。由于日语不对复数进行明确说明，很多这些句子可以适用于一个或多个事物，正如[第2课](./Lesson2.md)中所解释的。
...
正如[第0课](./Lesson0.md)所介绍的，更常见的做法是先引入一个"主题"，而不是明确地标记主语或宾语。为此，日语使用"主题标记"助词 <span lang="ja">は</span>，它的字面意思就是"这是我在谈论的内容"。大多数语法资源会将 <span lang="ja">は</span> 与 <span lang="ja">が</span> 进行比较。他们这样做是因为有时使用 <span lang="ja">が</span> 会不自然，你必须改用 <span lang="ja">は</span>，或者让主语不明确。但不要被误导，<span lang="ja">は</span> 比作为 <span lang="ja">が</span> 的替代品更通用。有时它在句子中代替 <span lang="ja">が</span>，将主语作为主题引入，但其他时候它也可以将宾语标记为主题。在这些情况下，由 <span lang="ja">を</span> 标记的东西被替换。如下面的例子所示。
...
另一个区别是，主题 <span lang="ja">は</span> 通常被假定为已经在对话中引入过的东西（类似于英语中的"the" vs "a"），或者是普遍理解为一般性陈述的东西。

例如，以下翻译都是有效的。上下文会明确哪个最合适。
