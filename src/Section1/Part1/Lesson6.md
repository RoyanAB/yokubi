# 助词 <span lang="ja">に</span>、<span lang="ja">へ</span> 和 <span lang="ja">から</span>

这些助词主要与位置有关。<span lang="ja">から</span> 表示动作的起点，<span lang="ja">へ</span> 和 <span lang="ja">に</span> 表示动作的终点或方向。

<span lang="ja">から</span> 与英语中的"from"基本用法相同，即使是在抽象意义下。
...
在日语中，如果主语已经被理解或不重要，可以省略。很多例句都会缺少明确的代词，所以我们的翻译会随便加一个，以便使它们易读。记住，仅仅因为一个例句翻译可能说"他"而不是"她"，并不意味着这在日语中是明确的。

<span lang="ja">へ</span> 在大多数情况下翻译为"to"或"toward"，包括抽象的情况。在前面的例子中，它也可以理解为"on"。翻译可以相当灵活。
...
<span lang="ja">に</span> 可以标记存在的位置或方向目标。后者的用法与 <span lang="ja">へ</span> 有些重叠，但 <span lang="ja">へ</span> 更关注运动和"朝……方向"，而 <span lang="ja">に</span> 更关注最终目标。它也可以标记动作发生的时间点。
...
<span lang="ja">に</span> 还有很多其他不标记位置、方向或时间的用法。它可以充当间接宾语或动作的目标。间接宾语是与动词相关或受动词影响但并非动词核心含义一部分的事物。
...
现在是一个很好的时机注意，助词也可以附着在短语上，而不仅仅是词上。这适用于我们迄今为止学到的每个助词。
